...
// Module: Tests.Main
// Imports: public import Init public meta import Init public import Tests.Harness public import Tests.ComponentTests public import Tests.EncoderTests public import Tests.DecoderTests public import Tests.PipelineTests public import Tests.CorpusTests
#include <lean/lean.h>
...
v___x_20_ = lp_maith_Tests_TrainingCorpus_runAllCorpusTests();
if (lean_obj_tag(v___x_20_) == 0)
{
lean_object* v___x_21_; 
lean_dec_ref_known(v___x_20_, 1);
v___x_21_ = lp_maith_IO_println___at___00Tests_printTestResult_spec__0(v___x_7_);
if (lean_obj_tag(v___x_21_) == 0)
{
lean_object* v___x_22_; 
lean_dec_ref_known(v___x_21_, 1);
v___x_22_ = lp_maith_IO_println___at___00Tests_printTestResult_spec__0(v___x_9_);
if (lean_obj_tag(v___x_22_) == 0)
{
lean_object* v___x_23_; lean_object* v___x_24_; 
lean_dec_ref_known(v___x_22_, 1);
v___x_23_ = ((lean_object*)(lp_maith_main___closed__4));
v___x_24_ = lp_maith_IO_println___at___00Tests_printTestResult_spec__0(v___x_23_);
if (lean_obj_tag(v___x_24_) == 0)
{
lean_object* v___x_25_; 
lean_dec_ref_known(v___x_24_, 1);
v___x_25_ = lp_maith_IO_println___at___00Tests_printTestResult_spec__0(v___x_13_);
if (lean_obj_tag(v___x_25_) == 0)
{
lean_object* v___x_26_; 
lean_dec_ref_known(v___x_25_, 1);
v___x_26_ = lp_maith_IO_println___at___00Tests_printTestResult_spec__0(v___x_7_);
return v___x_26_;
}
else
{
...
LEAN_EXPORT lean_object* lp_maith_main___boxed(lean_object* v_a_27_){
_start:
{
...
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
res = initialize_maith_Tests_CorpusTests(builtin);
if (lean_io_result_is_error(res)) return res;
lean_dec_ref(res);
