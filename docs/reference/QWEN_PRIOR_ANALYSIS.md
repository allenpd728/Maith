...
Other explanations for Variant A's underperformance should be investigated, particularly the normalizer hypothesis (see `docs/reference/NORMALISATION_AUDIT.md`).
