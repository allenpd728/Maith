...
| `check_decision_log.py` | Validates required entries exist in `docs/decisions/LOG.md` |
...
`docs/reference/docs/reference/docs/reference/CORPUS_SCHEMA.md`. Handles both v0.1.0 (`b(...)` / `t<n>`) and v1.0.0 (`BVAR_N` / `TERM_N`)
entity ID formats.
...
Key design choices (from `docs/experiments/EXPERIMENT_DESIGN.md`):
...
3. Record final Phase 5 results in `docs/experiments/EXPERIMENT_DESIGN.md`.
