...
**Date:** 2026-08-02
**Decision entry:** DEC-020 in `docs/DECISION_LOG.md`
**Status:** Complete.
...
| Decompiler Lean validity | Phase 7. See `docs/DECOMPILER_HANDOVER.md`. |
...
- `docs/DECISION_LOG.md` — DEC-020 (this result), DEC-016 (Phase 5 conclusion),
  DEC-018 (perplexity gate), DEC-019 (corpus expansion plan)
- `docs/PHASE_5_RESULTS.md` — Phase 5 baseline
- `docs/EXPERIMENT_DESIGN.md` — full experiment protocol
