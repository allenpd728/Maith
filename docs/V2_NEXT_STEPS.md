...
| Item | Status | Detail |
|---|---|---|
| v2 IR implemented (C1+C2+C4) | ✅ | `docs/v2_token_analysis.md`, commit `f194027` |
...
5. **Update `docs/V2_COMPARISON_MATRIX.md`** with the B-small result.

6. **Write DEC-027** in `docs/DECISION_LOG.md` with the gate outcome.
...
- [ ] `docs/V2_COMPARISON_MATRIX.md` updated with B-small result
...
- [ ] `docs/PHASE_7_ROADMAP.md` "Where We Stand" updated with final conclusion
...
> ```
> Then update `docs/V2_COMPARISON_MATRIX.md` and write DEC-027 in
> `docs/DECISION_LOG.md`. That's the merge-to-main signal.
