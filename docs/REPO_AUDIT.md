...
| `CORPUS_SCHEMA.md` | **KEEP** | Schema contract for corpus.jsonl; still accurate for v1.3.0 encoder | Referenced by docs/ENCODER_FORMAT.md, python/corpus_loader.py |
| `PHASE_5_COMPLETION_CHECKLIST.md` | **DELETE** | Deprecated; superseded by docs/DECISION_LOG.md and docs/PHASE_5_RESULTS.md. Explicitly marked deprecated in file. | Referenced by docs/SESSION_PROGRESS.md (historical) |

### docs/ Directory

| File | Classification | Reason | Cross-references |
|------|----------------|--------|------------------|
| `docs/DECISION_LOG.md` | **KEEP** | Canonical experiment decision record; recently updated (DEC-021, 2026-08-03) | Referenced by README.md, FUTURE_WORK.md, PHASE_7_ROADMAP.md, PHASE_7_DESIGN.md, IR_V2_FIX_SPEC.md |
| `docs/DECISION_INDEX.md` | **KEEP** | Navigation index for DECISION_LOG; useful for finding specific decisions | References DECISION_LOG.md |
| `docs/PHASE_7_ROADMAP.md` | **KEEP** | Current active roadmap; recently updated (2026-08-03) | Referenced by README.md, FUTURE_WORK.md, IR_V2_PROPOSAL.md |
| `docs/PHASE_5_RESULTS.md` | **KEEP** | Phase 5 historical results; authoritative record | Referenced by PHASE_5_COMPLETION_CHECKLIST.md (deprecated), DECISION_LOG.md |
| `docs/PHASE_6_RESULTS.md` | **KEEP** | Phase 6 historical results; authoritative record | Referenced by DECISION_LOG.md |
| `docs/PHASE_7_DESIGN.md` | **KEEP** | Phase 7 proof-term completion design; future direction | Referenced by PHASE_7_ROADMAP.md |
| `docs/ENCODER_FORMAT.md` | **KEEP** | Current encoder spec (v1.3.0); active specification | Referenced by IR_V2_FIX_SPEC.md, IR_V2_PROPOSAL.md, IR_SCHEMA_AUDIT.md |
| `docs/EXPERIMENT_DESIGN.md` | **KEEP** | A/B/C experiment methodology; authoritative | Referenced by DECISION_LOG.md |
| `docs/IR_SCHEMA_AUDIT.md` | **KEEP** | Schema noise analysis; referenced by PHASE_7_ROADMAP.md | References ENCODER_FORMAT.md, PHASE_7_ROADMAP.md |
| `docs/IR_V2_FIX_SPEC.md` | **KEEP** | Fix 1+2 implementation spec; active work | Referenced by PHASE_7_ROADMAP.md, DECISION_LOG.md |
| `docs/IR_V2_PROPOSAL.md` | **KEEP** | v2 IR design proposal; referenced by PHASE_7_ROADMAP.md | References ENCODER_FORMAT.md, IR_SCHEMA_AUDIT.md, REPRESENTATION_EVOLUTION.md |
| `docs/NORMALISATION_AUDIT.md` | **KEEP** | Normalisation audit findings; referenced | Referenced by IR_V2_FIX_SPEC.md, DECISION_LOG.md |
| `docs/QWEN_PRIOR_ANALYSIS.md` | **KEEP** | Analysis reference; linked from DECISION_INDEX.md | References python/qwen_prior_analysis.py |
| `docs/REPRESENTATION_EVOLUTION.md` | **KEEP** | Evolution strategy; active | Referenced by IR_V2_PROPOSAL.md, PYTHON_PIPELINE.md |
| `docs/DECOMPILER_HANDOVER.md` | **KEEP** | Decompiler handoff; referenced by PHASE_6_RESULTS.md | References EXAMPLE_ROUNDTRIP.md |
| `docs/EXAMPLE_ROUNDTRIP.md` | **KEEP** | Full pipeline walkthrough; educational | Referenced by DECOMPILER_HANDOVER.md, docs/SESSION_PROGRESS.md |
...
| `docs/Design.md` | **KEEP** | Architecture and design notes; referenced | Referenced by README.md, SESSION_PROGRESS.md |
...
| `docs/PYTHON_PIPELINE.md` | **KEEP** | Comprehensive python/ tooling reference; active | Referenced by docs/TEST.md |
...
| `python/validate_roundtrip.py` | **KEEP** | Decoder round-trip validator; referenced in docs | Referenced in docs/EXAMPLE_ROUNDTRIP.md, docs/TESTING_SUMMARY.md |
| `python/ir_normalisation_check.py` | **KEEP** | IR normalisation checking | Referenced in PYTHON_PIPELINE.md |
| `python/normalisation_audit.py` | **KEEP** | Normalisation audit; referenced in DECISION_LOG.md | Referenced in docs/NORMALISATION_AUDIT.md |
| `python/qwen_prior_analysis.py` | **KEEP** | Qwen prior analysis; referenced in QWEN_PRIOR_ANALYSIS.md | Referenced in docs/QWEN_PRIOR_ANALYSIS.md |
| `python/tokenizer_study.py` | **KEEP** | BPE fragmentation study; referenced in PYTHON_PIPELINE.md | Referenced in docs/PYTHON_PIPELINE.md |
...
|------|------------------|--------|
| `docs/DECISION_LOG.md` (DEC-005) | `docs/CONTEXT_PACK_PROTOCOL.md` | **BROKEN** — File does not exist |

**Evidence:**
```
grep -r "CONTEXT_PACK" docs/
docs/DECISION_LOG.md:  - `docs/CONTEXT_PACK_PROTOCOL.md`
```
...
| `docs/DECISION_LOG.md`, `docs/DECISION_INDEX.md`, `docs/PHASE_7_ROADMAP.md` | Recently updated, authoritative |
