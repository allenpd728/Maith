...
**Written:** 2026-08-03  
**Status:** Active � v2 control grid complete (DEC-026/027); IR-candidate search in progress  
...
- **Variant C completion-eval fix.** The 1.5% top-1 was a stale-checkpoint dir, not a model
  problem (see `docs/scratch/variant_c_eval_bug.md`). Fixed by quarantining `runs/_stale_variant_*`
...
`python/build_dataset.py` (structural token list), `docs/reference/ENCODER_FORMAT.md` (→ v1.4.0)  
...
**Spec:** `docs/reference/IR_V2_PROPOSAL.md` Section 3.
...
**Spec:** `docs/reference/IR_V2_PROPOSAL.md` Section 5.
...
are defensible. See `docs/experiments/V2_NEXT_STEPS.md` for the full checklist and
OpenHands prompt.
...
| Topic | Location |
|---|---|
| IR token grammar and version history | `docs/reference/ENCODER_FORMAT.md` |
| IR schema noise analysis | `docs/reference/IR_SCHEMA.md` |
| Fix 1+2 implementation spec | `docs/reference/IR_V2_FIX_SPEC.md` |
| Full v2 IR design proposal (IO markers, type-role prefixes, flat-IR) | `docs/reference/IR_V2_PROPOSAL.md` |
| Normalisation audit findings | `docs/reference/NORMALISATION_AUDIT.md` |
| Qwen pretraining prior analysis | `docs/reference/QWEN_PRIOR_ANALYSIS.md` |
| Representation registration and evolution workflow | `docs/reference/REPRESENTATION_EVOLUTION.md` |
| Full experimental history DEC-001 to DEC-025 | `docs/decisions/LOG.md` |
| Probing experiment spec | `docs/experiments/PROBING_TASK_FINAL.md` |
| Phase 7 proof-term completion design (separate from this roadmap) | `docs/history/PHASE_7_DESIGN.md` |
...
- docs/reference/IR_V2_PROPOSAL.md
- docs/reference/IR_V2_FIX_SPEC.md
