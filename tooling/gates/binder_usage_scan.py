#!/usr/bin/env python3
"""Gate 5 (Tier 1b) -- binder-usage / "lethality" scanner for Maith Lean source.
...
in the first PleaNP definitional renderings (PleaNP is the sibling project whose gate protocol Maith adopts; 2026-08-19 review):
...
Usage:
    ...
    python3 binder_usage_scan.py --strict Maith   # REVIEWs also fail
    python3 binder_usage_scan.py --allow-unreferenced '^exists_' Maith
