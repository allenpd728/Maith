...
- A/B/C results currently in `runs/` are smoke-only (`--smoke-test`: 50 examples, 1 epoch) and not decision-grade.
- Full 3-epoch A/B/C runs on the full train/eval splits are still pending.
